---
description: Design system architecture, technical structure, and design patterns for Flutter projects
mode: subagent
tools:
  write: true
  edit: true
...
- Research architectural patterns and solutions
- Examine existing architecture and documentation
- Understand current technical structure
- See how existing patterns are applied
